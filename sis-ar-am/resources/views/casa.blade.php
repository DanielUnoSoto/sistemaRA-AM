...
<head>
  ...
  <link href="vendors/coreui-icons.css" rel="stylesheet">
  <link href="vendors/flag-icon.css" rel="stylesheet">
  <link href="vendors/font-awesome.css" rel="stylesheet">
  <link href="vendors/simple-line-icons.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

  <link href="vendors/style.css" rel="stylesheet">
  <link href="vendors/pace.css" rel="stylesheet">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show   pace-done pace-done">
  ...
  <header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
      <img class="navbar-brand-full" src="vendors/logo.svg" alt="CoreUI Logo" width="89" height="25">
      <img class="navbar-brand-minimized" src="vendors/sygnet.svg" alt="CoreUI Logo" width="30" height="30">
    </a>
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
          ...
          <a class="dropdown-item" href="#">
            <div class="message">
              <div class="py-3 mr-3 float-left">
                <div class="avatar">
                  <img class="img-avatar" src="vendors/7.jpg" alt="admin@bootstrapmaster.com">
          ...
          <a class="dropdown-item" href="#">
            <div class="message">
              <div class="py-3 mr-3 float-left">
                <div class="avatar">
                  <img class="img-avatar" src="vendors/6.jpg" alt="admin@bootstrapmaster.com">
          ...
          <a class="dropdown-item" href="#">
            <div class="message">
              <div class="py-3 mr-3 float-left">
                <div class="avatar">
                  <img class="img-avatar" src="vendors/5.jpg" alt="admin@bootstrapmaster.com">
          ...
          <a class="dropdown-item" href="#">
            <div class="message">
              <div class="py-3 mr-3 float-left">
                <div class="avatar">
                  <img class="img-avatar" src="vendors/4.jpg" alt="admin@bootstrapmaster.com">
  ...
  <div class="app-body">
    <div class="sidebar">
      <nav class="sidebar-nav ps ps--active-y">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link active" href="https://coreui.io/demo/2.0/dark/main.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/demo/2.0/dark/colors.html">
              <i class="nav-icon icon-drop"></i> Colors</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/demo/2.0/dark/typography.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/breadcrumb.html">
                  <i class="nav-icon icon-puzzle"></i> Breadcrumb</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/cards.html">
                  <i class="nav-icon icon-puzzle"></i> Cards</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/carousel.html">
                  <i class="nav-icon icon-puzzle"></i> Carousel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/collapse.html">
                  <i class="nav-icon icon-puzzle"></i> Collapse</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/jumbotron.html">
                  <i class="nav-icon icon-puzzle"></i> Jumbotron</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/list-group.html">
                  <i class="nav-icon icon-puzzle"></i> List group</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/navs.html">
                  <i class="nav-icon icon-puzzle"></i> Navs</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/pagination.html">
                  <i class="nav-icon icon-puzzle"></i> Pagination</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/popovers.html">
                  <i class="nav-icon icon-puzzle"></i> Popovers</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/progress.html">
                  <i class="nav-icon icon-puzzle"></i> Progress</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/scrollspy.html">
                  <i class="nav-icon icon-puzzle"></i> Scrollspy</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/switches.html">
                  <i class="nav-icon icon-puzzle"></i> Switches</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/tabs.html">
                  <i class="nav-icon icon-puzzle"></i> Tabs</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/base/tooltips.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/buttons/buttons.html">
                  <i class="nav-icon icon-cursor"></i> Buttons</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/buttons/brand-buttons.html">
                  <i class="nav-icon icon-cursor"></i> Brand Buttons</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/buttons/button-group.html">
                  <i class="nav-icon icon-cursor"></i> Buttons Group</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/buttons/dropdowns.html">
                  <i class="nav-icon icon-cursor"></i> Dropdowns</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/buttons/loading-buttons.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/demo/2.0/dark/charts.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/editors/code-editor.html">
                  <i class="nav-icon icon-note"></i> Code Editor
                  <span class="badge badge-danger">PRO</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/editors/markdown-editor.html">
                  <i class="nav-icon fa fa-code"></i> Markdown
                  <span class="badge badge-danger">PRO</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/editors/text-editor.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/forms/basic-forms.html">
                  <i class="nav-icon icon-note"></i> Basic Forms</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/forms/advanced-forms.html">
                  <i class="nav-icon icon-note"></i> Advanced
                  <span class="badge badge-danger">PRO</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/forms/validation.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/demo/2.0/dark/google-maps.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/icons/coreui-icons.html">
                  <i class="nav-icon icon-star"></i> CoreUI Icons
                  <span class="badge badge-success">NEW</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/icons/flags.html">
                  <i class="nav-icon icon-star"></i> Flags</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/icons/font-awesome.html">
                  <i class="nav-icon icon-star"></i> Font Awesome
                  <span class="badge badge-secondary">4.7</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/icons/simple-line-icons.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/notifications/alerts.html">
                  <i class="nav-icon icon-bell"></i> Alerts</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/notifications/badge.html">
                  <i class="nav-icon icon-bell"></i> Badge</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/notifications/modals.html">
                  <i class="nav-icon icon-bell"></i> Modals</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/notifications/toastr.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/plugins/calendar.html">
                  <i class="nav-icon icon-calendar"></i> Calendar
                  <span class="badge badge-danger">PRO</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/plugins/draggable-cards.html">
                  <i class="nav-icon icon-cursor-move"></i> Draggable
                  <span class="badge badge-danger">PRO</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/plugins/sliders.html">
                  <i class="nav-icon icon-equalizer"></i> Sliders
                  <span class="badge badge-danger">PRO</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/plugins/spinners.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/tables/tables.html">
                  <i class="nav-icon icon-list"></i> Standard Tables</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/tables/datatables.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://coreui.io/demo/2.0/dark/widgets.html">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/login.html" target="_top">
                  <i class="nav-icon icon-star"></i> Login</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/register.html" target="_top">
                  <i class="nav-icon icon-star"></i> Register</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/404.html" target="_top">
                  <i class="nav-icon icon-star"></i> Error 404</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://coreui.io/demo/2.0/dark/500.html" target="_top">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                  <li class="nav-item">
                    <a class="nav-link" href="https://coreui.io/demo/2.0/dark/apps/invoicing/invoice.html">
              ...
              <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                  <li class="nav-item">
                    <a class="nav-link" href="https://coreui.io/demo/2.0/dark/apps/email/inbox.html">
                      <i class="nav-icon icon-speech"></i> Inbox
                      <span class="badge badge-danger">PRO</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="https://coreui.io/demo/2.0/dark/apps/email/message.html">
                      <i class="nav-icon icon-speech"></i> Message
                      <span class="badge badge-danger">PRO</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="https://coreui.io/demo/2.0/dark/apps/email/compose.html">
                  ...
                  <div class="card text-white bg-warning">
                    ...
                    <div class="chart-wrapper mt-3" style="height:70px;">
                      ...
                      <canvas class="chart chartjs-render-monitor" id="card-chart3" height="70" style="display: block;"
                        width="386"></canvas>
                      <div id="card-chart3-tooltip" class="chartjs-tooltip bottom"
                        style="opacity: 0; left: 257px; top: 135.2px;">
                        ...
                        <div class="tooltip-body">
                          <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                              ...
                              class="tooltip-body-item-value">34</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-7 d-none d-md-block">
                      ...
                      <div class="btn-group btn-group-toggle float-right mr-3" data-toggle="buttons">
                        ...
                        <label class="btn btn-outline-secondary active">
                          <input id="option2" type="radio" name="options" autocomplete="off" checked="checked"> Month
                        </label>
                        <label class="btn btn-outline-secondary">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-center">
                              <div class="avatar">
                                <img class="img-avatar" src="vendors/1.jpg" alt="admin@bootstrapmaster.com">
                                <span class="avatar-status badge-success"></span>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="avatar">
                                <img class="img-avatar" src="vendors/2.jpg" alt="admin@bootstrapmaster.com">
                                <span class="avatar-status badge-danger"></span>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="avatar">
                                <img class="img-avatar" src="vendors/3.jpg" alt="admin@bootstrapmaster.com">
                                <span class="avatar-status badge-warning"></span>
                              </div>
                            </td>
                            <td>
          ...
          <div class="list-group list-group-accent">
            ...
            <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
              ...
              <div class="avatars-stack mt-2">
                ...
                <div class="avatar avatar-xs">
                  <img class="img-avatar" src="vendors/8.jpg" alt="admin@bootstrapmaster.com">
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="vendors/pace.js"></script>
  <script src="vendors/perfect-scrollbar.js"></script>
  <script src="vendors/coreui.js"></script>
  <!-- <script>
    $('#ui-view').ajaxLoad();
 ...
 -->
  <script type="text/javascript" src="vendors/Chart.js" class="view-script"></script>
  <script type="text/javascript" src="vendors/custom-tooltips.js" class="view-script"></script>
  <script type="text/javascript" src="vendors/main.js" class="view-script"></script>
</body>
